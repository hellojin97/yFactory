			...
			<div class="mainTitle" style="padding: 15px;">
				...
				<div class="col-md-5 " style="padding-bottom: 20px;">
					<div class="input-group ">
						...
						<label for="inputText" class="col-form-label" style="padding-right: 44px;">자재명</label> 
				...
				<div class="col-md-5 " style="padding-bottom: 10px;">
					<div class="input-group  " style="padding-bottom: 10px;">
						<label for="inputText" class="col-form-label"style="padding-right: 44px;">업체명</label> 
				...
				<div class="col-md-5 " style="padding-bottom: 10px;">
					<div class="input-group  " style="padding-bottom: 10px;">
						<label for="inputText" class="col-form-label"style="padding-right: 27px;">불량코드</label> 
						<input type="text" class="form-control" style="width: 50px" id="" placeholder="업체명">
						<a class="nav-link nav-icon search-bar-toggle "id="vdr" onclick="vdr"> 
							<i class="bi bi-search" style="color: #2c3e50"></i>
						</a> 
						<input type="text" class="form-control" id="vdrCdinput" readonly="readonly">
